...
You'll also be able to use the provided SQL parser to run SQL queries against your database! See [Section 2.7](https://github.com/CreatorsStack/CreatorDB/blob/master/doc/lab2.md#parser) for a brief tutorial.
